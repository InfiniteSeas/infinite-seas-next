...
export default function IslandProductMenu({
  ...
  return (
    <div className="w-full h-full grid grid-cols-4 pt-4 gap-4">
      <p
        className="relative w-full h-full text-white cursor-pointer bg-no-repeat bg-contain flex flex-col justify-evenly items-center"
        onClick={() => setModalFlag(true)}
        style={{
          padding: "10px",
          background: `url("/image/16-Mining_Wood_Cutting_Planting/Large_box.png")`,
      ...
      >
        ...
        <div className="flex w-2/3 justify-evenly">
          10px/
          <img src="/image/16-Mining_Wood_Cutting_Planting/clock.png" style={{ height: "20px", width: "20px" }} /> 3
          Seconds
        </div>
        ...
        <div className="flex justify-center items-center">
          ...
          <img
            src="/image/16-Mining_Wood_Cutting_Planting/Progressbar_Background.png"
      ...
      {[2, 3, 4, 5, 6, 7, 8].map((id) => (
        ...
        >
          <div className="text-2xl flex items-center justify-center">
            <img src="/image/16-Mining_Wood_Cutting_Planting/Lock.png" className="w-[14%]" />
            Locked
          </div>
